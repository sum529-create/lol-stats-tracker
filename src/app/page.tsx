...
export default function Home() {
  return (
    <div className="w-full max-w-[1200px] mx-auto text-center break-keep">
      {/* 히어로 섹션 */}
      <div className="relative rounded-xl overflow-hidden mb-12 shadow-xl">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center z-20 p-6">
          ...
          <p className="text-md md:text-xl text-gray-200 max-w-2xl mb-8">
          ...
          <div className="flex gap-4">
            <Link
              ...
              className="bg-[#B33A3A] hover:bg-[#892f2f] text-sm md:text-xl text-white px-6 py-3 rounded-md font-medium transition-colors"
            >
              홈페이지로 이동
            </Link>
          </div>
      ...
      {/* 주요 기능 섹션 */}
      <div>
        <h2 className="text-2xl md:text-3xl font-bold mb-8">주요 기능</h2>
